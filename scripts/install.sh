...
if [ ! -d "packages/h5p-main/h5p/editor" ] || [ ! -d "packages/h5p-main/h5p/core" ]
then    
    sh packages/h5p-main/download-core.sh 661d4f6c7d7b1117587654941f5fcf91acb5f4eb 0365b081efa8b55ab9fd58594aa599f9630268f6
else
